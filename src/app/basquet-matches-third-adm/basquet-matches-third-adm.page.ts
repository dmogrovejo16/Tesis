...
export class BasquetMatchesThirdAdmPage implements OnInit {
  ...
  constructor(private storageService:StorageService,private el: ElementRef,private toastController: ToastController, private http: HttpClient, public _apiService: ApiService, public alertController:AlertController) {this.isButton1Disabled=this.isButton2Disabled; }
