...
@Component({
  selector: 'app-all-volley-matches-adm',
  templateUrl: './all-volley-matches-adm.page.html',
  styleUrls: ['./all-volley-matches-adm.page.scss'],
})
export class AllVolleyMatchesAdmPage implements OnInit {
