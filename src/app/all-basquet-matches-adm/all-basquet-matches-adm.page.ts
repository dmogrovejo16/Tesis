...
@Component({
  selector: 'app-all-basquet-matches-adm',
  templateUrl: './all-basquet-matches-adm.page.html',
  styleUrls: ['./all-basquet-matches-adm.page.scss'],
})
export class AllBasquetMatchesAdmPage implements OnInit {
  ...
  Eq2: any;
  partidos: any[] = [];
  constructor(private el: ElementRef,private toastController: ToastController, private http: HttpClient, public _apiService: ApiService, public alertController:AlertController) { }
